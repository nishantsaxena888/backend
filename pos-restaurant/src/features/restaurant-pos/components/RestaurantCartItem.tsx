...
import { RestaurantCartItem as CartItemType } from "../types";

interface RestaurantCartItemProps {
    item: CartItemType;
    onUpdateQuantity: (id: string, delta: number) => void;
    onRemove: (id: string) => void;
}

export function RestaurantCartItem({ item, onUpdateQuantity, onRemove }: RestaurantCartItemProps) {
    return (
