...
import { config as warehouseBlueConfig } from './clients/warehouse-blue/config';
import { products as warehouseBlueProducts } from './clients/warehouse-blue/products';
...
const CONFIGS: Record<string, ClientConfig> = {
    ...
    'warehouse-blue': warehouseBlueConfig,
};
...
const PRODUCTS: Record<string, Product[]> = {
    ...
    'warehouse-blue': warehouseBlueProducts,
};
