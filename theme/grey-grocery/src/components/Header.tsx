        ...
        <div className="max-w-7xl mx-auto px-4 py-2">
          <div className="flex items-center justify-between text-sm text-white">
            <div className="flex items-center gap-2">
              ...
              <span>Authorized Distributor - Coke, Pepsi, Major Brands | Wholesale Pricing</span>
            </div>
            <div className="hidden sm:flex items-center gap-6">
              <div className="flex items-center gap-2">
                <Phone className="w-3.5 h-3.5" />
                <span>1-800-WAREHOUSE</span>
              </div>
              <span>|</span>
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-gray-900 text-xl font-semibold">Pioneer</h1>
                <p className="text-gray-600 text-xs font-medium">Wholesale</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 max-w-2xl relative">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 pr-12 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent focus:bg-white transition-all"
              />
              <button className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-gray-700 hover:bg-gray-800 text-white rounded-md transition-colors">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2 p-3">
                        {categories.map((category, index) => (
                          <button
                            key={index}
                            className="flex items-center gap-2 p-2.5 rounded-md border border-gray-200 hover:border-blue-600 hover:bg-blue-50 transition-all text-sm"
                            onClick={() => handleSearchSelect(category.name, true)}
                          >
          ...
          <div className="flex items-center gap-3">
            ...
            <button 
              onClick={onCartClick}
              className="relative px-4 py-2 bg-gray-700 hover:bg-gray-800 rounded-lg transition-colors flex items-center gap-2"
              title="Shopping Cart"
            >
