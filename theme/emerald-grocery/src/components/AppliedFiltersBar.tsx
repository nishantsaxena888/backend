        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 bg-green-50 rounded-md border border-green-200">
            ...
            <span className="text-sm text-gray-900">
              <span className="font-semibold text-green-600">{productCount}</span> {productCount === 1 ? 'product' : 'products'}
            </span>
          </div>
          ...
          {hasPriceFilter && (
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 hover:border-green-500 transition-all group text-sm"
            >
          ...
          <button
            onClick={onClearAll}
            className="ml-auto px-4 py-1.5 bg-green-600 hover:bg-green-700 text-white rounded-md transition-colors text-sm font-medium"
          >
            Clear All
          </button>
        </div>
