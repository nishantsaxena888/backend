...
export default function App() {
  ...
  const [selectedCategory, setSelectedCategory] = useState<string>('All Restaurants');
    ...
    <div className="min-h-screen bg-white">
      ...
      <ProductDetail
        ...
        onRestaurantClick={(restaurantId) => {
          // Find restaurant from selected product
          if (selectedProduct?.restaurant) {
            setSelectedRestaurant(selectedProduct.restaurant);
      ...
      <RestaurantPage
        ...
        onAddToCart={addToCart}
        onProductClick={setSelectedProduct}
        allProducts={products} // We'll need to export products from ProductGrid
      />
    </div>
  );
}