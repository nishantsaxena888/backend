import { Search, ShoppingCart, MapPin, User, Clock, TrendingUp, X, LogOut, UtensilsCrossed } from 'lucide-react';
...
export function Header({ 
  ...
  const popularSearches = ['Biryani', 'Pizza', 'Burger', 'Dosa', 'Noodles', 'Ice Cream'];

  const allSuggestions = [
    'Butter Chicken', 'Paneer Tikka', 'Chicken Biryani', 'Masala Dosa',
    'Margherita Pizza', 'Pepperoni Pizza', 'Hakka Noodles', 'Chicken Fried Rice',
    'Classic Burger', 'Veggie Burger', 'Chocolate Cake', 'Gulab Jamun'
  ];
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="bg-black p-2 rounded-lg border-2 border-gray-700">
              <UtensilsCrossed className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-xl font-bold text-white">FoodHub</h1>
          ...
          <div className="flex-1 max-w-2xl relative hidden md:block">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 pr-12 bg-gray-100 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent focus:bg-white transition-all"
              />
