import { X, Star, StarHalf, ShoppingCart, Heart, Clock, MapPin, Flame, AlertCircle, ChefHat, Award, Leaf, TrendingUp, Store } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[90] overflow-y-auto flex items-center justify-center p-0 md:p-4">
        <div className="bg-white w-full h-full md:h-[95vh] md:rounded-3xl shadow-2xl overflow-hidden flex flex-col md:max-w-6xl">
              ...
              <div className="flex-1">
                ...
                {product.restaurant && (
                  <button
                    ...
                    className="text-sm text-gray-600 hover:text-black transition-colors mt-1 flex items-center gap-1"
                  >
                    <Store className="w-3 h-3" />
                    {product.restaurant.name} - View full menu
                  </button>
                )}
              </div>
            </div>
