              ...
              <div className="flex items-center justify-between max-w-md mx-auto">
                ...
                <div className="flex items-center gap-2">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                    ...
                    step === 'payment' ? 'bg-gray-900 text-white' : 'bg-green-500 text-white'
                  }`}>
                ...
                <div className="flex items-center gap-2">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                    step === 'review' ? 'bg-gray-900 text-white' : 'bg-gray-300 text-gray-600'
                  }`}>
                    3
                  </div>
              ...
              <div className="max-w-3xl mx-auto space-y-6">
                ...
                {getSavedAddresses().length > 0 && !useNewAddress && (
                  <div>
                    ...
                    <button
                      ...
                      className="w-full bg-black hover:bg-gray-900 text-white py-4 px-4 rounded-xl transition-all mt-6 disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
                    >
                      Continue to Payment
                    </button>
                  </div>
                ...
                {(getSavedAddresses().length === 0 || useNewAddress) && (
                  <form onSubmit={handleShippingSubmit} className="space-y-4">
                    ...
                    <button
                      type="submit"
                      className="w-full bg-black hover:bg-gray-900 text-white py-4 px-4 rounded-xl transition-all mt-6 font-semibold"
                    >
                      Continue to Payment
                    </button>
                  </form>
            ...
            {step === 'review' && (
              <div className="max-w-3xl mx-auto">
                ...
                <button
                  ...
                  className="w-full bg-black hover:bg-gray-900 text-white py-4 px-4 rounded-xl transition-all text-lg font-semibold shadow-lg hover:shadow-xl"
                >
