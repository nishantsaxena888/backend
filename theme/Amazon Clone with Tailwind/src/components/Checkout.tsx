              ...
              <div className="max-w-3xl mx-auto space-y-6">
                ...
                {getSavedAddresses().length > 0 && !useNewAddress && (
                  <div>
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-4 px-4 rounded-xl transition-all mt-6 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Continue to Payment
                    </button>
                  </div>
                ...
                {(getSavedAddresses().length === 0 || useNewAddress) && (
                  <form onSubmit={handleShippingSubmit} className="space-y-4">
                    ...
                    <button
                      type="submit"
                      className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-4 px-4 rounded-xl transition-all mt-6"
                    >
                      Continue to Payment
                    </button>
                  </form>
            ...
            {step === 'review' && (
              <div className="max-w-3xl mx-auto">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-4 px-4 rounded-xl transition-all text-lg"
                >
                  Place Order
                </button>
              </div>
