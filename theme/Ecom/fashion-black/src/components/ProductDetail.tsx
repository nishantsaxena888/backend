  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[90] overflow-y-auto flex items-center justify-center p-0 md:p-4">
        <div className="bg-white w-full h-full md:h-[95vh] md:rounded-none shadow-2xl overflow-hidden flex flex-col md:max-w-6xl border border-gray-200">
          ...
          <div className="bg-white border-b border-gray-200 p-4 md:p-6 flex items-center justify-between">
            <div className="flex items-center gap-3 flex-1">
              ...
              <div className="flex-1">
                <h2 className="text-xl md:text-2xl font-bold text-black">{product.title}</h2>
                {product.brand && (
