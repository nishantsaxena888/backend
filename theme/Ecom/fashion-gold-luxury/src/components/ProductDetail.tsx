import { X, Star, StarHalf, ShoppingCart, Heart, Clock, MapPin, Flame, AlertCircle, ChefHat, Award, Leaf, TrendingUp, Store, Sparkles, Package, Shield } from 'lucide-react';
    ...
    <>
      ...
      <div className="fixed inset-0 z-[90] overflow-y-auto flex items-center justify-center p-0 md:p-4">
        <div className="bg-gradient-to-b from-gray-50 to-white w-full h-full md:h-[95vh] md:rounded-3xl shadow-2xl overflow-hidden flex flex-col md:max-w-6xl border border-gray-200">
          ...
          <div className="bg-gradient-to-r from-gray-900 via-black to-gray-900 border-b border-yellow-900/30 p-4 md:p-6 flex items-center justify-between">
            <div className="flex items-center gap-3 flex-1">
              ...
              <div className="flex-1">
                <h2 className="text-xl md:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-200">{product.title}</h2>
                {product.brand && (
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-6 p-4 md:p-6">
              ...
              <div className="space-y-4">
                ...
                {/* Fashion Specifications Card */}
                <div className="bg-gradient-to-br from-rose-50 to-pink-100/50 rounded-2xl p-5 border border-rose-200">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {product.gender && (
                      <div>
                        ...
                        <p className="font-bold text-gray-900">{product.gender}</p>
                      </div>
                    )}
                    {product.collection && (
                      <div>
                        <p className="text-xs text-gray-600 mb-1">Collection</p>
                        <p className="font-bold text-gray-900">{product.collection}</p>
                      </div>
                    )}
                    {product.colors && product.colors.length > 0 && (
                      <div>
                        <p className="text-xs text-gray-600 mb-1">Colors</p>
                        <p className="font-bold text-gray-900">{product.colors.length} options</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-2xl p-5 border border-gray-200">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-700">100% Genuine</p>
                      <p className="text-xs text-gray-500 mt-1">Certificate included</p>
                    </div>
                  </div>
                </div>
              </div>
