...
export function HeroSection({ config }: HeroSectionProps) {
    ...
    return (
        <div className="relative py-8 md:py-24 px-4 overflow-hidden rounded-[32px] md:rounded-[40px] mx-2 md:mx-4 my-4 md:my-8 bg-primary/5 border border-primary/10">
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
                <div className="flex-1 space-y-8 text-center md:text-left animate-in slide-in-from-left duration-700">
                    ...
                    <h2 className="text-3xl sm:text-5xl md:text-8xl font-black tracking-tighter text-foreground leading-[0.9] break-words">
                        {l(config, 'hero.headline')}
                    </h2>
                    <p className="text-lg md:text-2xl text-muted-foreground max-w-xl font-medium leading-relaxed">
