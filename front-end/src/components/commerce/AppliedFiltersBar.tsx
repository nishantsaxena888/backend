...
export function AppliedFiltersBar({
    ...
    return (
        <div className="bg-background/80 backdrop-blur-md sticky top-[136px] z-30 border-b border-border/50 transition-all duration-300">
            <div className="max-w-7xl mx-auto px-4 py-3 sm:py-4">
                <div className="flex flex-wrap items-center gap-3">

                    {/* Results Summary */}
                    <div className="flex items-center gap-2 pr-4 border-r border-border/50 mr-1">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[10px] text-muted-foreground font-bold tracking-widest leading-none mt-0.5">MATCHED</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 flex-1">
                        {hasCategory && (
                            <Badge variant="secondary" className="pl-3 pr-1 py-1.5 rounded-full border-primary/20 bg-primary/5 hover:bg-primary/10 group animate-in fade-in slide-in-from-left-2">
                                <span className="text-xs font-bold text-primary mr-2">{selectedCategory}</span>
                    ...
                    <div className="hidden lg:flex items-center gap-4">
                        <Button variant="outline" size="sm" className="rounded-full gap-2 border-border/50 text-xs font-bold">
                            <SlidersHorizontal className="w-3 h-3" /> Sort by: Newest
                        </Button>
                    </div>
                </div>
            </div>
